...
import time,random,sys,json,codecs,requests,threading,glob,sys
import re,string,os
import os.path,sys,urllib,shutil,subprocess
import requests

cl = LINETCR.LINE()
cl.login(token="EmgRXfBvbpEMW7i9Z514.k2K4G8GMT6aSz/sjRTTG5a.ehHA7rFtIvdelU8vJ9Xrk0UFh+uMZysXwFZKcPHltpQ=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Em9yEDnZSBaUaytgQrId.jmDhjpfohb2AknjpNg7Ohq.Jmy6b8yKlupLLnHhaWJiY2N/t11hmpx/xT1gGaEbWyo=")#(qr=True)
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EmnxFnR5H3gFXnMbEr00.8h1kluhb9x+RLufRjx5/Wa.yEY5yWsTGchlJ7xsLXM0ojKezwSKmEBSx+n6m8aNacI=")#(qr=True)
kk.loginResult()

ks = LINETCR.LINE()
ks.login(token="EmxIKrdYoDbJ9dMQfI8d.Vn3x60GkkbhMA+Th+FV6tq.ne4u1Kbi/5SJSr87zblbE6yt5ibUjqm2zL7ZGVQQ+iY=")#(qr=True)
ks.loginResult()
...
#-----------------------------------------------------------   
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                cl.sendText(msg.to,"Berhasil bos")
           ...
           #-----------------------------------------------
                ...
                nk0 = msg.text.replace("tr-hr ","")
                nk1 = nk0.lstrip()
                nk2 = nk1.replace("","")
                nk3 = nk2.rstrip()
                _name = nk3
                trans = translate(_name, 'hr')
                cl.sendText(msg.to,str(trans))
            elif "tr-zh-TW" in msg.text:
                nk0 = msg.text.replace("tr-zh-TW ","")
                nk1 = nk0.lstrip()
                nk2 = nk1.replace("","")
                nk3 = nk2.rstrip()
                _name = nk3
                trans = translate(_name, 'zh-TW')
                cl.sendText(msg.to,str(trans))
            elif "tr-zh-CN" in msg.text:
                nk0 = msg.text.replace("tr-zh-CN ","")
                nk1 = nk0.lstrip()
                nk2 = nk1.replace("","")
                nk3 = nk2.rstrip()
                _name = nk3
                trans = translate(_name, 'zh-CN')
                cl.sendText(msg.to,str(trans))
            elif "tr-ny" in msg.text:
                nk0 = msg.text.replace("tr-ny ","")
                nk1 = nk0.lstrip()
                nk2 = nk1.replace("","")
                nk3 = nk2.rstrip()
                _name = nk3
                trans = translate(_name, 'ny')
                cl.sendText(msg.to,str(trans))
            elif "tr-ca" in msg.text:
                nk0 = msg.text.replace("tr-ca ","")
                nk1 = nk0.lstrip()
                nk2 = nk1.replace("","")
                nk3 = nk2.rstrip()
                _name = nk3
                trans = translate(_name, 'ca')
                cl.sendText(msg.to,str(trans))
            elif "tr-bg" in msg.text:
                nk0 = msg.text.replace("tr-bg ","")
                nk1 = nk0.lstrip()
                nk2 = nk1.replace("","")
                nk3 = nk2.rstrip()
                _name = nk3
                trans = translate(_name, 'bg')
                cl.sendText(msg.to,str(trans))
            elif "tr-bs" in msg.text:
                nk0 = msg.text.replace("tr-bs ","")
                nk1 = nk0.lstrip()
                nk2 = nk1.replace("","")
                nk3 = nk2.rstrip()
                _name = nk3
                trans = translate(_name, 'bs')
                cl.sendText(msg.to,str(trans))
            elif "tr-bn" in msg.text:
                nk0 = msg.text.replace("tr-bn ","")
                nk1 = nk0.lstrip()
                nk2 = nk1.replace("","")
                nk3 = nk2.rstrip()
                _name = nk3
                trans = translate(_name, 'bn')
                cl.sendText(msg.to,str(trans))
            elif "tr-be" in msg.text:
                nk0 = msg.text.replace("tr-be ","")
                nk1 = nk0.lstrip()
                nk2 = nk1.replace("","")
                nk3 = nk2.rstrip()
                _name = nk3
                trans = translate(_name, 'be')
                cl.sendText(msg.to,str(trans))
            elif "tr-eu" in msg.text:
                nk0 = msg.text.replace("tr-eu ","")
                nk1 = nk0.lstrip()
                nk2 = nk1.replace("","")
                nk3 = nk2.rstrip()
                _name = nk3
                trans = translate(_name, 'eu')
                cl.sendText(msg.to,str(trans))
            elif "tr-az" in msg.text:
                nk0 = msg.text.replace("tr-az ","")
                nk1 = nk0.lstrip()
                nk2 = nk1.replace("","")
                nk3 = nk2.rstrip()
                _name = nk3
                trans = translate(_name, 'az')
                cl.sendText(msg.to,str(trans))
...
#-------------------Fungsi spam finish----------------------------
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                       cl.sendText(g.mid,"􀬁􀅼bomb􏿿")
                       kk.sendText(g.mid,"􀬁􀅼bomb􏿿")  
                       ki.sendText(g.mid,"􀬁􀅼bomb􏿿hahaha􀬁􀅼bomb􏿿")  
                       ks.sendText(g.mid,"􀬁􀅼bomb􏿿")
                       kk.sendText(g.mid,"􀬁􀅼bomb􏿿")  
                       ki.sendText(g.mid,"􀬁􀅼bomb􏿿")  
                       ks.sendText(g.mid,"􀬁􀅼bomb􏿿")
                       kk.sendText(g.mid,"􀬁􀅼bomb􏿿")  
                       ki.sendText(g.mid,"􀬁􀅼bomb􏿿")  
                       ks.sendText(g.mid,"􀬁􀅼bomb􏿿")
